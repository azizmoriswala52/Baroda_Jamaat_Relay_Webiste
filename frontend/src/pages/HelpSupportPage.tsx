    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }} className="pb-10">
      <div className="mb-8">
        <div className="flex justify-between items-center">
          <h3 className="text-2xl font-bold text-brand-accent dark:text-blue-300 tracking-wide">Help & Support</h3>
        </div>
            ...
            <div className="space-y-6">
              <div className="space-y-1">
                ...
                <input
                  ...
                  value={user?.itsId || ''}
                  disabled
                  className="input-field bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 cursor-not-allowed border-transparent"
                />
              </div>

            <div className="space-y-1">
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-2 uppercase tracking-wide">What help or support do you need from us?</label>
              <textarea
                name="query"
              ...
              >
                {submitQueryMutation.isPending ? (
                  <span className="flex items-center">
                    <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-brand-accent dark:text-blue-300" fill="none" viewBox="0 0 24 24">
